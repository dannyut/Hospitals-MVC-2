...
namespace HospitalsMVC2.Controllers
{
    public class HospitalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("HospitalId,Name,Address,Email,Phone")] Hospital hospital)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("HospitalId,Name,Address,Email,Phone")] Hospital hospital)
        {
